...
cd sdk/dotnet-sdk/src/VeritySDK/ && dotnet restore && dotnet build --configuration release /warnaserror && cd - # DotNet SDK build with warning as error
cd sdk/dotnet-sdk/src/VeritySDK.Test/ && dotnet test && cd - # DotNet SDK testing
