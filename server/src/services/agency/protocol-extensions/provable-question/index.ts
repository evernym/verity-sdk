...
| 'did:sov:123456789abcdefghi1234;spec/question-answer/0.1/question'
| 'did:sov:123456789abcdefghi1234;spec/question-answer/0.1/problem-report'
| 'did:sov:123456789abcdefghi1234;spec/question-answer/0.1/status'
...
export class ProvableQuestion extends Protocol {
    ...
    public router(message: IProvableQuestion) {
        switch (message['@type']) {
            case 'did:sov:123456789abcdefghi1234;spec/question-answer/0.1/question':
    ...
    private generateStatusReport(status: number, messageId: string, statusMessage: string, content?: string) {
        return {
            '@id': uuid(),
            '@type': 'did:sov:123456789abcdefghi1234;spec/question-answer/0.1/status',
