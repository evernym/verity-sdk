...
| 'did:sov:d8xBkXpPgvyR=d=xUzi42=PBbw;spec/proof/0.1/request'
| 'did:sov:d8xBkXpPgvyR=d=xUzi42=PBbw;spec/proof/0.1/problem-report'
| 'did:sov:d8xBkXpPgvyR=d=xUzi42=PBbw;spec/proof/0.1/status'
...
export class Proof extends Protocol {
    ...
    public router(message: IProofMessage) {
        switch (message['@type']) {
            case 'did:sov:d8xBkXpPgvyR=d=xUzi42=PBbw;spec/proof/0.1/request':
