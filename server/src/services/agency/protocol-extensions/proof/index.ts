...
| 'did:sov:123456789abcdefghi1234;spec/present-proof/0.1/request'
| 'did:sov:123456789abcdefghi1234;spec/present-proof/0.1/problem-report'
| 'did:sov:123456789abcdefghi1234;spec/present-proof/0.1/status'
...
export class Proof extends Protocol {
    ...
    public router(message: IProofMessage) {
        switch (message['@type']) {
            case 'did:sov:123456789abcdefghi1234;spec/present-proof/0.1/request':
