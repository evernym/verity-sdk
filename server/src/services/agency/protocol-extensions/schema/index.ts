...
| 'did:sov:123456789abcdefghi1234;spec/write-schema/0.1/write'
| 'did:sov:123456789abcdefghi1234;spec/write-schema/0.1/problem-report'
| 'did:sov:123456789abcdefghi1234;spec/write-schema/0.1/status'
...
export class Schema extends Protocol {
    ...
    public router(message: ISchemaMessage) {
        switch (message['@type']) {
            case 'did:sov:123456789abcdefghi1234;spec/write-schema/0.1/write':
    ...
    private generateStatusReport(status: number, statusMessage: string, message: ISchemaMessage, content?: any) {
        let msg = {
            '@type': 'did:sov:123456789abcdefghi1234;spec/write-schema/0.1/status',
            '@id': uuid(),
            '~thread': {
                pthid: message['@id'],
                seqnum: 0,
