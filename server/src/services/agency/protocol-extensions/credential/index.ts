...
| 'did:sov:d8xBkXpPgvyR=d=xUzi42=PBbw;spec/credential/0.1/credential'
| 'did:sov:d8xBkXpPgvyR=d=xUzi42=PBbw;spec/credential/0.1/problem-report'
| 'did:sov:d8xBkXpPgvyR=d=xUzi42=PBbw;spec/credential/0.1/status'
...
export class Credential extends Protocol {
    ...
    public router(message: ICredential) {
        switch (message['@type']) {
            case 'did:sov:d8xBkXpPgvyR=d=xUzi42=PBbw;spec/credential/0.1/credential':
