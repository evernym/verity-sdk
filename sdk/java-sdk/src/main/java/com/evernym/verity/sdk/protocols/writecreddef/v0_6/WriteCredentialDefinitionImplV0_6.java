 ...
 * SDK/enterprise.
 */
public class WriteCredentialDefinitionImplV0_6 extends Protocol implements WriteCredentialDefinitionV0_6 {
     ...
     */
    public WriteCredentialDefinitionImplV0_6(String name, String schemaId) {
     ...
     */
    public WriteCredentialDefinitionImplV0_6(String name,
                                      String schemaId,
                                      String tag) {
     ...
     */
    public WriteCredentialDefinitionImplV0_6(String name, String schemaId, RevocationRegistryConfig revocation) {
