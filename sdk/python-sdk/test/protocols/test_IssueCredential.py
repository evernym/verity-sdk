...
name = 'degree'
serialized_cred_def = '...serialized_cred_def_data...'
credential_values = {
  'name': 'Joe',
  'degree': 'Bachelors',
  'gpa': '3.67'
...
def test_init():
  issueCredential = IssueCredential(name, serialized_cred_def, credential_values, price)

  assert issueCredential.name == name
  assert issueCredential.serialized_cred_def == serialized_cred_def
...
async def test_issue():
  ...
  assert msg['credentialData']['serialized_cred_def'] == serialized_cred_def
