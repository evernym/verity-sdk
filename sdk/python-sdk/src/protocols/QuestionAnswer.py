...
class QuestionAnswer(Protocol):
    ...
    def __init__(self, connection_id: str, notification_title: str, question_text: str, question_detail: str, valid_responses: List[str]):
    ...
    def get_nonce(question_text: str, valid_response: str) -> str:
        hash = sha3_256()
        hash.update(question_text.encode('utf-8'))
        hash.update(valid_response.encode('utf-8'))
        hash.update(QuestionAnswer.get_random_bytes())
