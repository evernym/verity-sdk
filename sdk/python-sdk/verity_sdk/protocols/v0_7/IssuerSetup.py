...
class IssuerSetup(Protocol):
    ...
    async def create(self, context, ledgerPrefix, endorser=None):
        """
    ...
    def create_msg(self, context, ledgerPrefix, endorser=None):
        """
    ...
    async def create_msg_packed(self, context, ledgerPrefix, endorser=None):
        """
        ...
        """
        return await self.get_message_bytes(context, self.create_msg(context, ledgerPrefix, endorser))
