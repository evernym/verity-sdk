...
namespace VeritySDK.Protocols.PresentProof
{
    ...
    public class Predicate : AsJsonObject
    {
        ...
        /// <param name="type">(optional) parameter type (">=", ">", "<=", "<") defaults to ">=" if not specified</param>
        ...
        public Predicate(string name, string type, int value, params Restriction[] restrictions)
        {
            this.data = new JsonObject();
            data.Add("name", name);
            data.Add("p_type", type);
