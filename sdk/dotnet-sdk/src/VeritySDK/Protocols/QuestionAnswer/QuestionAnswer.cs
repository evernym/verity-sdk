...
namespace VeritySDK.Protocols.QuestionAnswer
{
    ...
    {
        /// <summary>
        /// Constructor for the 1.0 QuestionAnswer object. This constructor creates an object that is ready to ask the given question 
        /// </summary>
        ...
        /// <returns>1.0 QuestionAnswer object</returns>
        ...
        {
            return new QuestionAnswerV1_0(forRelationship, questionText, questionDetail, validResponses, signatureRequired);
        }

        /// <summary>
        /// Constructor for the 1.0 QuestionAnswer object. This constructor creates an object that is ready to answer the the asked question 
        /// </summary>
        /// <param name="forRelationship">the relationship identifier (DID) for the pairwise relationship that will be used</param>
        ...
        public static QuestionAnswerV1_0 v1_0(string forRelationship,
                                       ...
                                       string answer)
        {
            return new QuestionAnswerV1_0(forRelationship, threadId, answer);
        }
        ...
        public static QuestionAnswerV1_0 v1_0(string forRelationship,
                                              string threadId)
        {
            return new QuestionAnswerV1_0(forRelationship, threadId);
        }
    }
}