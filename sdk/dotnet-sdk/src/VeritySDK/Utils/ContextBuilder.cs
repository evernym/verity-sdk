...
namespace VeritySDK
{
    ...
    public class ContextBuilder
    {
        ...
        public ContextBuilder json(JsonObject json)
        {
            ...
            this.walletConfig(w);
            putElementIgnoreNull(ContextConstants.ENDPOINT_URL, json.Get(ContextConstants.ENDPOINT_URL));
            putElementIgnoreNull(ContextConstants.VERITY_URL, json.Get(ContextConstants.VERITY_URL));
            string version = json.Get(ContextConstants.VERSION);
        ...
        {
            putElementIgnoreNull(ContextConstants.VERITY_PUBLIC_DID, json.Get(ContextConstants.VERITY_PUBLIC_DID));
            putElementIgnoreNull(ContextConstants.VERITY_PUBLIC_VER_KEY, json.Get(ContextConstants.VERITY_PUBLIC_VER_KEY));
            putElementIgnoreNull(ContextConstants.DOMAIN_DID, json.Get(ContextConstants.DOMAIN_DID));
            putElementIgnoreNull(ContextConstants.VERITY_AGENT_VER_KEY, json.Get(ContextConstants.VERITY_AGENT_VER_KEY));
            putElementIgnoreNull(ContextConstants.SDK_VER_KEY_ID, json.Get(ContextConstants.SDK_VER_KEY_ID));
            putElementIgnoreNull(ContextConstants.SDK_VER_KEY, json.Get(ContextConstants.SDK_VER_KEY));
        ...
        {
            putElementIgnoreNull(ContextConstants.VERITY_PUBLIC_DID, json.Get(ContextConstants.VERITY_PUBLIC_DID));
            putElementIgnoreNull(ContextConstants.VERITY_PUBLIC_VER_KEY, json.Get(ContextConstants.LEGACY_VERITY_PUBLIC_VER_KEY));
            putElementIgnoreNull(ContextConstants.DOMAIN_DID, json.Get(ContextConstants.LEGACY_DOMAIN_DID));
            putElementIgnoreNull(ContextConstants.VERITY_AGENT_VER_KEY, json.Get(ContextConstants.LEGACY_VERITY_AGENT_VER_KEY));
            putElementIgnoreNull(ContextConstants.SDK_VER_KEY_ID, json.Get(ContextConstants.LEGACY_SDK_VER_KEY_ID));
            putElementIgnoreNull(ContextConstants.SDK_VER_KEY, json.Get(ContextConstants.LEGACY_SDK_VER_KEY));
        ...
        protected static Context scratchContext(WalletConfig wallet, string verityUrl, string seed) // throws WalletException, IOException 
        {
        ...
        private static Context withProvisionedAgent(Context inter, string domainDID, string verityAgentVerKey) // throws WalletException
        {
        ...
        protected static Context scratchContext(WalletConfig wallet, string verityUrl, Did verityDid, string seed) // throws WalletException
        {
