...
## Issue Credential
When an entity provides data to another party, the Issue Credential protocol is used. Both the [Issuer Setup](../howto/java-verity-flow.md#setting-up-an-issuer-identity) and [Write Credential Definition](../howto/java-verity-flow.md#write-credential-definition-to-ledger) protocols need to have been completed.
