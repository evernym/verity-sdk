...
namespace VeritySDK.Protocols.WriteCredDef
{
    ...
    public class WriteCredentialDefinition
    {
        ...
        {
            return new WriteCredentialDefinitionV0_6(name, schemaId);
        }
        ...
        {
            return new WriteCredentialDefinitionV0_6(name, schemaId, tag);
        }
        ...
        {
            return new WriteCredentialDefinitionV0_6(name, schemaId, revocation);
        }
